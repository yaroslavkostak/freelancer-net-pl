        ...
        <div className="container mx-auto px-0 md:px-4 flex items-center justify-between">
          <div className="flex items-center space-x-2">
            ...
            <Link
              ...
              aria-label="Freelancer.org.pl - головна сторінка (українська)"
            >
              Freelancer.org.pl
            </Link>
          </div>
          ...
          <div className="max-w-6xl mx-auto mt-12">
            <div className="bg-blue-50 rounded-lg p-6">
              ...
              <p className="text-gray-700 text-base leading-relaxed mb-6">
                При обранні inFakt (близько 200 злотих на місяць) вони безкоштовно допоможуть відкрити фірму та налаштувати все необхідне. ти зосереджуєшся на роботі, а inFakt веде бухгалтерію та звітність.
              </p>
        ...
        <main className="flex-1 w-full min-w-0 max-w-3xl mx-auto px-4 sm:px-6 md:px-8 py-8 md:py-12">
          ...
          <section id="legal-status" className="mb-16 scroll-mt-20">
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                ...
                ти можеш обирати будь-яку форму діяльності, від незареєстрованої до повноцінної компанії.
              </p>
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                ...
                Перед початком діяльності варто перевірити, чи не потрібні спеціальні дозволи для твого виду бізнесу.
              </p>
              ...
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Процес отримання карти побиту на підставі бізнесу вимагає підготовки пакету документів, який включає <strong>докази доходу, сплати податків, внесків ZUS та корисності твого бізнесу для польської економіки</strong>. 
                Розглядання заяви зазвичай триває <strong>від 1 до 3 місяців</strong>.
              </p>
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Карта тимчасового побиту надає тобі <strong>повні права на перебування та роботу в Польщі</strong>, 
              ...
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                ...
                Якщо ти плануєш працювати фрілансером більше 90 днів, <strong>обов'язково потрібно оформити карту тимчасового побиту</strong>. 
              ...
              <div className="mt-6 mb-6">
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 leading-relaxed text-lg">
                      inFakt безкоштовно допоможе зареєструвати JDG онлайн через CEIDG. Після реєстрації отримаєш NIP та REGON.
                    </p>
                  </div>
          ...
          <section id="unregistered-activity" className="mb-16 scroll-mt-20">
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Це спеціальний правовий режим для дрібного бізнесу. ти працюєш легально, але не реєструєте фірму в реєстрі <strong>CEIDG</strong>. Це рятівне коло для тих, чий дохід поки що невеликий - <strong>до 3500-3600 злотих на місяць</strong> (приблизно 800-900 євро).
              </p>
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Це діяльність фізичної особи, яка не є офіційним підприємництвом. ти надаєте послуги або продаєте товари як приватна особа.
              </p>
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                ти маєш право виставляти рахунки (<em>rachunki</em>) або навіть фактури (<em>faktury</em>). Клієнти можуть офіційно вносити ці витрати у свою бухгалтерію. Це робить тебе повноцінним гравцем на ринку.
              </p>
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
              ...
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                <strong>На якому статусі перебувати під час незареєстрованої діяльності?</strong> ти можеш працювати на незареєстрованій діяльності, перебуваючи в Польщі за <strong>безвізовим режимом (до 90 днів)</strong> або маючи <strong>PESEL UKR</strong>. Також можна працювати, якщо у тебе є <strong>карта тимчасового побиту</strong>, отримана на іншій підставі (наприклад, робота за трудовим договором або навчання).
              </p>
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                <strong>Скільки може тривати незареєстрована діяльність?</strong> Теоретично, незареєстрована діяльність може тривати необмежено, поки ти не перевищуєш місячний ліміт доходу (3500-3600 злотих). Проте на практиці більшість фрілансерів переходять на <strong>JDG</strong> протягом <strong>3-6 місяців</strong>, коли дохід стабілізується або зростає. Якщо ти плануєш працювати довше 6 місяців або твій дохід регулярно перевищує ліміт, обов'язково потрібно зареєструвати JDG.
              </p>
              ...
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Головна умова полягає в тому, що твій щомісячний дохід не повинен перевищувати певну суму. Ця сума становить <strong>75% від мінімальної заробітної плати брутто в Польщі</strong>.
              </p>
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                З 1 січня 2026 року мінімальна зарплата зросла, тому твій ліміт тепер складає близько <strong>3500-3600 злотих на місяць</strong> (точну цифру слід перевіряти на момент виплати). <em>Якщо ти перевищив цей ліміт хоча б на 1 злотий, ти зобов'язаний зареєструвати JDG протягом 7 днів</em>.
              </p>
              ...
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Ця модель доступна для громадян України, які легально перебувають у Польщі. <strong>Головна вимога</strong> полягає в тому, що ти не повинен були вести власну фірму (<strong>JDG</strong>) у Польщі протягом <strong>останніх 60 місяців</strong>.
              </p>
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Це ідеально підходить для <em>копірайтерів, дизайнерів, репетиторів, маркетологів, перекладачів, контент-менеджерів та інших фахівців</em> на старті. ти просто починаєте працювати без жодних візитів до держустанов.
              </p>
              ...
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                <em>Тобі не потрібен бухгалтер</em>. Єдиний документ, який ти зобов'язаний вести, це <strong>Ewidencja sprzedaży</strong> (спрощений реєстр продажів).
              </p>
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                ти просто записуєш дату, суму та кому надали послугу. Це потрібно для того, щоб податкова могла перевірити, чи не перевищив ти місячний ліміт доходу.
              </p>
              ...
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Це найбільша перевага незареєстрованої діяльності. ти <strong>не платите обов'язкові соціальні внески (ZUS)</strong> як підприємець. ти економите близько <strong>1600-2000 злотих на місяць</strong>, які платять підприємці на JDG.
              </p>
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Проте пам'ятайте: якщо ти надаєте послуги за договором <strong>Umowa zlecenie</strong>, замовник може бути зобов'язаний заплатити внески за тебе. Це варто обговорити з клієнтом заздалегідь.
              </p>
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                <strong>Важливо:</strong> без сплати <strong>ZUS</strong> ти не маєш права на безкоштовну медицину в Польщі (окрім екстрених випадків) та не накопичуєш пенсію.
              </p>
              ...
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Доходи від незареєстрованої діяльності не оподатковуються щомісяця. ти звітуєте за них лише раз на рік.
              </p>
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                ти вказуєте загальну суму доходу та твої витрати у річній декларації PIT-36. ти платиш податок лише з чистого прибутку за загальною шкалою (зазвичай 12%).
              </p>
          ...
          <section id="jdg" className="mb-16 scroll-mt-20">
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Реєстрація <strong>JDG</strong> (<em>Jednoosobowa Działalność Gospodarcza</em> - український еквівалент <strong>ФОП</strong> або <strong>ІП</strong>) це крок до повної професійної незалежності. ти отримуєш податковий номер <strong>NIP</strong> (<em>Numer Identyfikacji Podatkowej</em> - номер ідентифікації платника податків), стаєте повноцінним контрагентом і можете працювати з будь-якими компаніями у світі.
              </p>
              ...
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Код <strong>PKD</strong> (<em>Polska Klasyfikacja Działalności</em> - Польська класифікація діяльності) визначає, чим саме займається твій бізнес. Це обов'язковий код, який вказується при реєстрації JDG. ти можеш обрати один основний код і необмежену кількість додаткових.
              </p>
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
              ...
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                ти можеш вказати дату реєстрації "сьогодні" або майбутню дату. <strong>Важливо: не можна вказувати дату заднім числом</strong>, якщо ти не займався незареєстрованою діяльністю раніше.
              </p>
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Як адресу ти можеш вказати власне житло (якщо орендодавець не проти) або скористатися <strong>Wirtualne biuro</strong>. Віртуальний офіс у Кракові чи Варшаві це законний спосіб мати престижну бізнес-адресу за <strong>60-100 злотих на місяць</strong>.
              </p>
              ...
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Після подачі заяви в <strong>CEIDG у тебе є 7 днів</strong>, щоб подати уточнюючі форми до <strong>ZUS</strong>.
              </p>
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                <strong>ZZA</strong> - якщо ти реєструєшся лише на медичне страхування (наприклад, працюєте ще десь за трудовим договором).
              </p>
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                <strong>ZUA</strong> - якщо ти реєструєшся на повне соціальне страхування (пенсійне, інвалідність тощо).
              </p>
              ...
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                За законом, для JDG не завжди обов'язково мати окремий бізнес-рахунок (якщо ти не платник VAT). Проте на практиці більшість банків вимагають розділяти особисті та ділові кошти.
              </p>
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
              ...
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Це означає, що якщо ти не можеш сплатити борги бізнесу (<strong>податки, ZUS, борги перед клієнтами</strong>), кредитори можуть стягнути твоє особисте майно.
              </p>
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                <strong>Як захиститися</strong>
              </p>
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Є кілька способів захистити майно. Застрахувати професійну відповідальність (OC) особливо важливо для IT та маркетологів. Розділити майно з подружжям (intercyza) захищає майно подружжя від боргів твого бізнесу. Створити ТОВ замість JDG можливо, але це складніше та дорожче.
              </p>
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                <strong>Важливо розуміти</strong>
              </p>
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Власний бізнес це не лише дохід, а й повний ризик твоїм капіталом. Важливо правильно вести бізнес та дотримуватися всіх обов'язків, щоб уникнути проблем.
              </p>
              <div className="bg-blue-50 rounded-lg p-4 mt-4">
                <p className="text-gray-700 font-semibold mb-2">Офіційні джерела</p>
                <ul className="text-gray-700 space-y-1 text-sm">
          ...
          <section id="business-incubators" className="mb-16 scroll-mt-20">
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Бізнес-інкубатор це організація, яка надає тобі свою юридичну особу для виставлення рахунків клієнтам. ти стаєш "суб'єктом" всередині інкубатора, а він виступає посередником між тобою та твоїм замовником. Це особливо популярно серед іноземців, які хочуть делегувати бюрократію, але має важливі нюанси.
              </p>
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                <strong>Головний ризик - відсутність сплати ZUS</strong>
              </p>
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Коли ти працюєте через інкубатор, ти не платиш <strong>ZUS</strong> як підприємець, оскільки юридично ти не є підприємцем. Це означає, що ти <strong>не накопичуєте пенсію</strong> та <strong>не маєте права на безкоштовну медицину</strong> в Польщі (окрім екстрених випадків). Якщо ти плануєш довгостроково працювати в Польщі, це може стати серйозною проблемою.
              </p>
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                <strong>Відповідальність та ризики</strong>
              </p>
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Працюючи через інкубатор, ти залежиш від його фінансової стабільності. Якщо інкубатор має проблеми з податковою або закривається, це може вплинути на твої доходи. ти також не маєш прямого контролю над своїми фінансами. Гроші спочатку надходять на рахунок інкубатора, і лише потім виплачуються тобі.
              </p>
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                <strong>Податкові ризики</strong>
              </p>
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Податкова може перевірити, чи не є твоя робота через інкубатор <em>фіктивною</em>. Якщо ти фактично працюєш як підприємець (самостійно шукаєте клієнтів, контролюєте процес роботи, працюєте на своєму обладнанні), але формально працюєте через інкубатор, це може бути визнано як спроба уникнути сплати ZUS та податків. Це загрожує <strong>штрафами та зобов'язанням сплатити всі несплачені внески</strong>.
              </p>
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                <strong>Коли це може бути виправданим</strong>
              </p>
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Робота через інкубатор може мати сенс лише для <strong>короткострокових проектів</strong> (до 3-6 місяців), коли ти ще не впевнений, чи хочете довгостроково працювати в Польщі. Також це може підходити для тих, хто вже має інше джерело страхування (наприклад, працює за трудовим договором і має ZUS через роботодавця).
              </p>
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                <strong>Альтернатива - JDG</strong>
              </p>
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Для більшості фрілансерів <strong>JDG є більш безпечним та прозорим варіантом</strong>. ти маєш повний контроль над своїми фінансами, накопичуєш пенсію, маєш право на медицину та не залежиш від третьої сторони. Хоча JDG вимагає сплати ZUS, це інвестиція у твоє майбутнє та легальність твоєї діяльності.
              </p>
              ...
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                ти підписуєш договір з інкубатором (зазвичай цивільно-правовий). Коли ти виконуєш роботу для клієнта, інкубатор виставляє йому рахунок від свого імені.
              </p>
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Гроші надходять на рахунок інкубатора, вони відраховують податки та свою комісію, а решту виплачують тобі як зарплату. ти отримуєш "чисті" гроші без необхідності реєструвати JDG у CEIDG.
              </p>
              <h3 id="business-incubators-2" className="text-2xl font-semibold text-gray-900 mb-4 mt-8">
                Переваги для іноземців (з обережністю)
              </h3>
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Теоретично, це може бути зручним варіантом, якщо ти не знаєш польської мови на достатньому рівні для спілкування з податковою. Інкубатор бере на себе бухгалтерію, звітність та юридичний супровід.
              </p>
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Проте <strong>важливо розуміти</strong>, що ти залежиш від інкубатора та його компетентності. Якщо інкубатор робить помилки в бухгалтерії або не сплачує податки вчасно, <strong>відповідальність може лягти на тебе</strong>. Також ти не маєте прямого доступу до своїх фінансів - все проходить через інкубатора.
              </p>
              ...
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Замість складних розрахунків ZUS, ти платите фіксовану щомісячну суму за менторинг та адміністрування. У 2026 році це зазвичай становить від <strong>300 до 600 злотих на місяць</strong>.
              </p>
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Ця модель може здаватися вигіднішою за JDG на початкових етапах, оскільки твої витрати не залежать від обороту. ти платиш за сервіс лише тоді, коли у тебе є активні контракти.
              </p>
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Проте важливо враховувати, що ти не накопичуєш пенсію та не маєте права на безкоштовну медицину. Також ти залежиш від стабільності інкубатора та його фінансового стану. Якщо інкубатор має проблеми, це може вплинути на твої доходи та доступ до коштів.
              </p>
              ...
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Працюючи через інкубатор, ти не несеш юридичної відповідальності за діяльність інкубатора. Проте ти залежиш від його фінансової стабільності та правильності ведення справ. Якщо інкубатор робить помилки в бухгалтерії або не сплачує податки вчасно, це може вплинути на твої доходи та репутацію.
              </p>
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Важливо розуміти, що ти не маєте прямого контролю над своїми фінансами. Гроші спочатку надходять на рахунок інкубатора, і лише потім виплачуються тобі. Якщо інкубатор має фінансові проблеми або закривається, ти можете втратити доступ до своїх коштів.
              </p>
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Податкова може перевірити, чи не є твоя робота через інкубатор фіктивною. Якщо ти фактично працюєш як підприємець, але формально працюєте через інкубатор, це може бути визнано як спроба уникнути сплати <strong>ZUS</strong> та податків. Це загрожує штрафами та зобов'язанням сплатити всі несплачені внески.
              </p>
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                На відміну від <strong>JDG</strong>, де ти маєш повний контроль над своїми фінансами та відповідальністю, працюючи через інкубатор, ти делегуєш цей контроль третій стороні. Це створює додаткові ризики, які важливо враховувати при виборі моделі роботи.
              </p>
              ...
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Оскільки ти офіційно працевлаштований в інкубаторі, процедура отримання посвідки на проживання стає стандартною та зрозумілою для інспектора в Уженді.
              </p>
              ...
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                ти також обмежені внутрішніми правилами інкубатора щодо витрат. Наприклад, списати витрати на пальне або оренду офісу через інкубатор складніше, ніж у власному <strong>JDG</strong>.
              </p>
              ...
              <p className="text-gray-700 leading-relaxed text-lg">
                Якщо твоя діяльність не підходить під формат інкубатора, 
          ...
          <section id="civil-contracts" className="mb-16 scroll-mt-20">
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Якщо ти не хочеш реєструвати бізнес або вступати в інкубатор, ти можеш працювати за разовими договорами. У Польщі це називається "Umowy cywilnoprawne". Це законний спосіб отримувати гроші за конкретний результат або час.
              </p>
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
              ...
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Головна перевага полягає у відсутності внесків у ZUS. ти платиш лише податок на дохід (PIT). Якщо ти передаєш авторські права на свій код або текст, ти можеш застосувати 50% витрат на отримання доходу (KUP), що знижує податок удвічі.
              </p>
              <div className="bg-blue-50 rounded-lg p-4 mt-4">
                <p className="text-gray-700 font-semibold mb-2">Офіційні джерела</p>
                <ul className="text-gray-700 space-y-1 text-sm">
              ...
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Це "договір доручення". ти зобов'язуєшся виконувати певні дії у визначений час. Тут податкове навантаження вище, бо ти зобов'язаний платити внески на пенсійне та медичне страхування.
              </p>
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
              ...
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Наприклад, при Umowa o dzieło ти отримаєш на руки близько 88% від суми. При Umowa zlecenie (якщо ти не студент) це близько 70-75%. Завжди уточнюйте, чи включає ціна вартість податкових відрахувань.
              </p>
              <div className="bg-blue-50 rounded-lg p-4 mt-4">
                <p className="text-gray-700 font-semibold mb-2">Офіційні джерела</p>
                <ul className="text-gray-700 space-y-1 text-sm">
              ...
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Якщо ти живеш в Польщі (податковий резидент - ти ним стаєш офіційно після 180 днів перебування в країні) і працюєте на замовника з США чи України за договором, ти зобов'язаний самостійно задекларувати цей дохід.
              </p>
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Тобі не потрібно реєструвати фірму, але раз на рік ти маєш подати декларацію PIT-36. Польща має договори про уникнення подвійного оподаткування з багатьма країнами, що дозволяє не платити податок двічі.
              </p>
              <div className="bg-blue-50 rounded-lg p-4 mt-4">
                <p className="text-gray-700 font-semibold mb-2">Офіційні джерела</p>
                <ul className="text-gray-700 space-y-1 text-sm">
              ...
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                ...
                ти залишаєтеся власником результату роботи.
              </p>
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
              ...
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                ...
                Нетто - це сума після вирахування податку, яку ти отримуєш на руки.
              </p>
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
              ...
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Якщо ти працюєте з клієнтами з-за кордону за цивільно-правовими договорами, 
                оподаткування залежить від країни клієнта.
              </p>
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Для клієнтів з ЄС часто застосовується механізм Reverse Charge. 
                Податок сплачує клієнт у своїй країні, а не ти.
              </p>
              <p className="text-gray-700 leading-relaxed text-lg">
                Для клієнтів з-за меж ЄС доходи можуть бути звільнений від польського податку. 
          ...
          <section id="laws-regulations" className="mb-16 scroll-mt-20">
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Це «Конституція» для кожного фрілансера з JDG. Закон чітко визначає, що підприємницька діяльність це щось, що ти робиш систематично, від власного імені та з метою отримання прибутку.
              </p>
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Головне правило: держава має підтримувати підприємця. Закон впроваджує принцип «що не заборонено, те дозволено». Також він захищає тебе від безпідставних перевірок.
              </p>
              <div className="bg-blue-50 rounded-lg p-4 mt-4">
                <p className="text-gray-700 font-semibold mb-2">Офіційні джерела</p>
              ...
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Якщо ти перебуваєш в Польщі понад 183 дні на рік або тут знаходиться твій «центр життєвих інтересів» (сім'я, дім), ти стаєш польським податковим резидентом. Це означає, що ти маєш звітувати перед польською податковою (Uząd Skarbowy) про всі свої доходи, навіть якщо вони отримані на Upwork або від замовників з України.
              </p>
              <div className="bg-blue-50 rounded-lg p-4 mt-4">
                <p className="text-gray-700 font-semibold mb-2">Офіційні джерела</p>
                <p className="text-gray-700 text-sm"><a href="https://isap.sejm.gov.pl/isap.nsf/DocDetails.xsp?id=WDU19971370926" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">Ordynacja podatkowa</a> - Податковий кодекс з правилами відносин між тобою та податковою, офіційний текст та оновлення в системі ISAP.</p>
              </div>
              ...
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Податкова служба (<strong>Krajowa Administracja Skarbowa</strong> або <strong>KAS</strong>) має право перевірити твою діяльність. Проте, згідно із законом, вони повинні попередити тебе про перевірку заздалегідь (зазвичай за <strong>7 днів</strong>).
              </p>
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
              ...
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Якщо ти збираєш email-адреси для розсилки, ведете базу клієнтів або маєте сайт із формою зворотного зв'язку, ти підпадаєш під дію <strong>RODO</strong> (загальноєвропейський регламент <strong>GDPR</strong>).
              </p>
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                ти зобов'язаний повідомити клієнта, як ти використовуєш його дані. Для звичайного фрілансера це означає наявність <strong>«Політики конфіденційності»</strong> на сайті та обережне поводження з документами замовників.
              </p>
              <div className="bg-blue-50 rounded-lg p-4 mt-4">
                <p className="text-gray-700 font-semibold mb-2">Офіційні джерела</p>
              ...
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                У 2023-2026 роках польський уряд значно оновив Кодекс праці та норми щодо дистанційної роботи. Хоча фрілансери це не наймані працівники, ці норми впливають на те, як ти оформлюєш договори з великими польськими фірмами.
              </p>
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
          ...
          <section id="taxation-systems" className="mb-16 scroll-mt-20">
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Вибір системи оподаткування це головне рішення, яке вплине на те, скільки грошей залишиться у твоїй кишені. У 2026 році в Польщі існує три основні варіанти для JDG.
              </p>
              ...
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Це базова система. ти платиш <strong>12%</strong> з чистого прибутку, якщо заробляєте до <strong>120 000 злотих на рік</strong>. Якщо більше, ставка зростає до <strong>32%</strong>.
              </p>
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Головний бонус це <strong>Kwota wolna od podatku</strong> (сума, вільна від податку). ти не платиш прибутковий податок з перших <strong>30 000 злотих</strong> доходу. Також ти можеш віднімати витрати на бізнес (<em>ноутбук, софт, оренда</em>) від доходу перед розрахунком податку.
              </p>
              <div className="bg-blue-50 rounded-lg p-4 mt-4">
                <p className="text-gray-700 font-semibold mb-2">Офіційні джерела</p>
              ...
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Тут ставка завжди фіксована на рівні <strong>19%</strong>, незалежно від того, заробив ти 50 тисяч чи 500 тисяч злотих. ти також можеш віднімати витрати.
              </p>
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Ця система вигідна лише тоді, коли твої доходи стабільно перевищують <strong>120-150 тисяч злотих на рік</strong>. Тут немає «вільної від податку суми», тому для малих доходів вона збиткова.
              </p>
              <div className="bg-blue-50 rounded-lg p-4 mt-4">
                <p className="text-gray-700 font-semibold mb-2">Офіційні джерела</p>
              ...
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                <strong>Найпопулярніша система серед фрілансерів</strong>. ти платиш відсоток від усієї суми, яку отримали від клієнта. Витрати (оренда, техніка) врахувати не можна.
              </p>
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <div className="space-y-4 mb-6">
                ...
                <div>
                  ...
                  <p className="text-gray-700 leading-relaxed text-lg">
                    Якщо твій річний дохід перевищує 200 000 zł, ставка автоматично збільшується до 17%. 
              ...
              <div className="mb-6">
                <p className="text-gray-700 leading-relaxed text-lg">
                  ...
                  ти платиш тільки мінімальні внески (~1 700 zł/міс), незалежно від розміру доходу. 
          ...
          <section id="zus-insurance" className="mb-16 scroll-mt-20">
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                У Європі ця система працює десятиліттями. Вона гарантує, що навіть якщо ти втратиш роботу або захворієш, держава тебе не залишить без допомоги. Польща зросла завдяки реформам саме тому, що <strong>ZUS</strong> це одна з основних решійних сил країни. Коли ти платиш внески, ти інвестуєш у стабільність держави, в якій живеш, а держава інвестує в тебе.
              </p>
              ...
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Як підприємець на JDG ти платите внески щомісяця, навіть якщо не заробили нічого. У 2026 році повний <strong>ZUS</strong> становить близько <strong>1600-2000 злотих на місяць</strong>. Ця сума складається з кількох частин: пенсійне страхування (близько 19% від бази), медичне страхування (9% від бази), страхування на випадок інвалідності та нещасного випадку (близько 1,5%).
              </p>
              ...
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Сума внесків <strong>ZUS</strong> залежить від мінімальної зарплати в Польщі. Кожного року уряд підвищує мінімальну зарплату (у 2026 році це близько 4300-4500 злотих брутто), і від цієї суми розраховуються внески. Чим вища мінімальна зарплата, тим більше ти платите. Але це також означає, що твоя майбутня пенсія буде вищою, а медичне обслуговування кращим.
              </p>
              ...
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Якщо ти платите <strong>ZUS</strong>, твоя сім'я (дружина/чоловік та діти) також мають право на безкоштовну медицину. Діти до 18 років отримують безкоштовні ліки, безкоштовні щеплення та профілактичні огляди. Твоє подружжя може користуватися медициною, якщо не працює або не має власного страхування.
              </p>
              ...
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Розмір пенсії залежить від того, скільки років ти платив внески та який був твій дохід. Мінімальна пенсія в Польщі у 2026 році становить близько <strong>1200-1400 злотих</strong>. Середня пенсія близько <strong>2500-3000 злотих</strong>. Максимальна пенсія може досягати <strong>5000-6000 злотих</strong> або більше, якщо ти платив високі внески багато років. Щоб отримати повну пенсію, потрібно платити внески <strong>не менше 20-25 років</strong> (для жінок) або <strong>25-30 років</strong> (для чоловіків).
              </p>

              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                <strong>ZUS</strong> це державна страхова компанія. Навіть якщо ти нічого не заробив за місяць, як підприємець ти зобов'язаний платити внески. Але для новачків є пільги.
              </p>
              ...
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Протягом <strong>перших 6 повних місяців</strong> після реєстрації JDG ти звільнений від сплати соціальних внесків. ти платиш лише медичне страхування (<strong>Składka zdrowotna</strong>). Це дозволяє суттєво зекономити на старті, поки ти шукаєш клієнтів.
              </p>
              <div className="bg-blue-50 rounded-lg p-4 mt-4">
                <p className="text-gray-700 font-semibold mb-2">Офіційні джерела</p>
              ...
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Після закінчення "Ulga na start" ти можете перейти на пільговий період на <strong>24 місяці</strong>. ти платиш внески, розраховані від зниженої бази (від мінімальної зарплати). Це все ще значно менше, ніж повний ZUS, який платять досвідчені бізнесмени.
              </p>
              <div className="bg-blue-50 rounded-lg p-4 mt-4">
                <p className="text-gray-700 font-semibold mb-2">Офіційні джерела</p>
              ...
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Повний <strong>ZUS</strong> у 2026 році це серйозна сума (близько <strong>1600-2000 злотих</strong> залежно від розрахунків). ти також можеш добровільно платити внесок на випадок хвороби (<strong>Chorobowe</strong>). Це дає право на оплачуваний лікарняний, що важливо для фрілансера, який працює сам на себе.
              </p>
              <div className="bg-blue-50 rounded-lg p-4 mt-4">
                <p className="text-gray-700 font-semibold mb-2">Офіційні джерела</p>
          ...
          <section id="vat" className="mb-16 scroll-mt-20">
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                ти звільнений від <strong>VAT</strong>, поки твій річний оборот не перевищує <strong>200 000 злотих</strong>. Як тільки ти наближаєтесь до цієї суми, ти зобов'язаний зареєструватися як платник VAT (форма <strong>VAT-R</strong>).
              </p>
              <div className="bg-blue-50 rounded-lg p-4 mt-4">
                <p className="text-gray-700 font-semibold mb-2">Офіційні джерела</p>
              ...
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Якщо ти плануєш працювати з клієнтами з інших країн ЄС (наприклад, виконувати замовлення для фірми з Німеччини), тобі потрібно отримати номер <strong>VAT-UE</strong>. Це дозволяє виставляти рахунки без VAT, оскільки податок сплачує замовник у своїй країні (<strong>Reverse Charge</strong>).
              </p>
              <div className="bg-blue-50 rounded-lg p-4 mt-4">
                <p className="text-gray-700 font-semibold mb-2">Офіційні джерела</p>
          ...
          <section id="accounting-finance" className="mb-16 scroll-mt-20">
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Цей розділ допоможе тобі організувати щоденну рутину фрілансера так, щоб податкова не мала зайвих запитань. Ми переходимо до практичного управління фінансами та автоматизації процесів.
              </p>
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
              ...
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Якщо ти обрали загальну систему або лінійний податок, твій головний документ це <strong>KPiR</strong>. Це детальний журнал, куди ти записуєш кожен зароблений злотий та кожну витрату на бізнес.
              </p>
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Для тих, хто обрав <strong>Ryczałt</strong>, усе простіше. ти ведеш лише реєстр доходів (<strong>Ewidencja przychodów</strong>). Витрати тебе не цікавлять, оскільки вони не впливають на розмір податку.
              </p>
              ...
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                У <strong>2026 році</strong> в Польщі стає обов'язковою Національна система електронних фактур (<strong>KSeF</strong>). Це означає, що ти більше не зможете просто надіслати PDF-файл клієнту.
              </p>
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
              ...
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Якщо твоя система оподаткування дозволяє враховувати витрати, ти можете суттєво зекономити. До витрат можна віднести ноутбук, монітор, периферію, оренду офісу або частину витрат на житло (якщо там зареєстрована фірма), професійне навчання та курси, телефонний зв'язок та інтернет.
              </p>
              ...
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Альтернатива це онлайн-бухгалтерія (наприклад, iFirma або wFirma). Це дешевше, і ти самі вносите дані, а система генерує декларації.
              </p>
              ...
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                ...
                ти зустрічаєтеся з бухгалтером особисто, він веде всі документи.
              </p>
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
              ...
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Традиційне бюро краще для складних випадків або якщо ти не хочеш займатися бухгалтерією взагалі. 
                Але це дорожче.
              </p>
              <p className="text-gray-700 leading-relaxed text-lg">
          ...
          <section id="technical-legal" className="mb-16 scroll-mt-20">
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Це твої цифрові ключі. Profil Zaufany дозволяє підписувати державні документи, подавати декларації та змінювати дані в реєстрі CEIDG онлайн.
              </p>
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Додаток mObywatel це твій паспорт і водійське посвідчення в телефоні. Він також інтегрований з бізнес-послугами, що дозволяє швидко підтверджувати особу при відкритті банківських рахунків.
              </p>
              <div className="bg-blue-50 rounded-lg p-4 mt-4">
                <p className="text-gray-700 font-semibold mb-2">Офіційні джерела</p>
              ...
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Якщо ти отримуєте дохід через платформи-посередники, пам'ятайте про валютний контроль. ти повинні перераховувати отримані USD або EUR у польські злоті за курсом Національного банку Польщі (NBP) на день, що передує дню отримання оплати.
              </p>
              <div className="bg-blue-50 rounded-lg p-4 mt-4">
                <p className="text-gray-700 font-semibold mb-2">Офіційні джерела</p>
          ...
          <section id="conclusions" className="mb-16 scroll-mt-20">
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Перший крок це переконатися, що ти легально перебуваєте в Польщі. PESEL UKR або карта побиту дають право на ведення бізнесу.
              </p>
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                <strong>2. Створити Profil Zaufany</strong>
              </p>
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Profil Zaufany це твій цифровий ключ до всіх державних послуг. Без нього неможливо зареєструвати бізнес онлайн.
              </p>
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                <strong>3. Обрати форму - Незареєстрована діяльність чи JDG</strong>
              </p>
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Обери форму діяльності залежно від твого доходу. Незареєстрована діяльність підходить, якщо дохід до 3500-3600 zł на місяць. JDG підходить, якщо дохід більший або хочеш повноцінний статус підприємця.
              </p>
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
              ...
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Після реєстрації ти можете починати працювати та виставляти рахунки-фактури. Не забудьте зареєструватися в ZUS протягом 7 днів після отримання NIP.
              </p>
              ...
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Не бійтеся звертатися до професійної допомоги. Бухгалтер або консультант може заощадити тобі багато часу та грошей.
              </p>
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
          ...
          <section id="employment-vs-selfemployed" className="mb-16 scroll-mt-20">
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                На JDG у тебе немає оплачуваної відпустки (20-26 днів), як на трудовому договорі. ти заробляєте лише тоді, коли працюєте. Якщо ти не працюєте, ти не отримуєте гроші.
              </p>
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                ти можеш взяти відпустку, але вона буде безкоштовною. ти не отримаєте оплату за дні, коли не працюєте.
              </p>
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                <strong>На Umowa o pracę</strong>
              </p>
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                На трудовому договорі ти маєш право на оплачувану відпустку (20-26 днів на рік). ти також маєте право на оплачуваний лікарняний.
              </p>
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Це означає, що навіть коли ти не працюєте через хворобу або відпустку, ти все одно отримуєте зарплату.
              </p>
              ...
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Розірвання трудового договору вимагає часу (від 2 тижнів до 3 місяців залежно від стажу). Роботодавець не може просто звільнити тебе без причини.
              </p>
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Якщо роботодавець хоче тебе звільнити, він має дотримуватися процедури та сплатити відступні.
              </p>
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
          ...
          <section id="legal-liability" className="mb-16 scroll-mt-20">
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Це розділ, який часто пропускають, але він є критично важливим для безпеки. Розуміння відповідальності допоможе тобі захистити своє майно та уникнути серйозних проблем.
              </p>
              ...
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Це означає, що якщо ти не можеш сплатити борги бізнесу, кредитори можуть стягнути твоє особисте майно.
              </p>
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                <strong>Як захиститися</strong>
              </p>
              ...
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Страхування професійної відповідальності (OC) це страхування, яке покриває збитки клієнта через твої помилки.
              </p>
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
          ...
          <section id="b2b-contracts" className="mb-16 scroll-mt-20">
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                <strong>Коли податкова може перекваліфікувати твій B2B-контракт</strong>
              </p>
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Податкова може перекваліфікувати твій B2B-контракт у трудовий договір, якщо ти працюєте в офісі клієнта під його прямим керівництвом та за визначеним ним графіком.
              </p>
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
              ...
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Якщо податкова перекваліфікує твій контракт, це загрожує штрафами для клієнта, втратою права на пільги ZUS, проблемами з податковою та втратою права на Ryczałt (для певних категорій).
              </p>
              ...
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Так, але ти втратиш право на деякі пільги ZUS та ставку податку Ryczałt (для певних категорій), якщо послуги ідентичні тим, що ти надавав як працівник.
              </p>
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                <strong>Умови</strong>
              </p>
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Між звільненням та підписанням B2B-контракту має пройти мінімум 6 місяців. Послуги не повинні бути ідентичними тим, що ти надавав як працівник. ти повинні працювати з іншими клієнтами одночасно.
              </p>
            </div>
          </section>
          ...
          <section id="reporting-requirements" className="mb-16 scroll-mt-20">
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Деталізація того, що саме перевіряє уряд, допоможе тобі підготуватися до перевірок та уникнути проблем.
              </p>
              ...
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Хоча це автоматично, важливо розуміти, що твій бізнес класифікується для статистичних звітів.
              </p>
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
              ...
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                REGON присвоюється автоматично під час реєстрації в CEIDG. ти не потрібно робити нічого додаткового.
              </p>
              ...
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Соцстрах може перевіряти, чи не є твоя самозайнятість фіктивною (наприклад, якщо ти звільнився з компанії та наступного дня підписали з нею ж B2B-контракт).
              </p>
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                <strong>Наслідки фіктивної самозайнятості</strong>
              </p>
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                У такому разі ти можете втратити право на пільгу "Ulga na start", отримати штраф від ZUS та втратити право на Ryczałt (для певних категорій).
              </p>
              ...
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Податкова може перевіряти твої рахунки-фактури, банківські виписки, договори з клієнтами, облік доходів та витрат та правильність розрахунку податків.
              </p>
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                <strong>Права під час перевірки</strong>
              </p>
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Під час перевірки ти маєш право знати причину перевірки, мати адвоката, мати перекладача (якщо не знаєш польської) та отримувати копії всіх документів.
              </p>
            </div>
          </section>
          ...
          <section id="how-to-start" className="mb-16 scroll-mt-20">
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Початок кар'єри фрілансера може здаватися складним, але з правильною стратегією та підготовкою ти зможете швидко стати успішним незалежним професіоналом.
              </p>
              ...
              <p className="text-gray-700 leading-relaxed mb-4 text-lg">
                Якщо ти не впевнені, почніть з <strong>найпростіших професій</strong>: копірайтинг, переклади, введення даних, обробка зображень. Це дозволить тобі набратися досвіду та зрозуміти, що тобі підходить.
              </p>
              ...
              <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-4 text-lg">
                <li><strong>Копірайтер</strong> - якщо ти добре пишете, можете почати з простих текстів для сайтів та соціальних мереж</li>
                <li><strong>Перекладач</strong> - якщо ти вільно володієте двома мовами, переклади це стабільний дохід</li>
                ...
                <li><strong>Онлайн-репетитор</strong> - якщо ти експерт у якійсь галузі, можете навчати інших</li>
              ...
              <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-4 text-lg">
                ...
                <li><strong>Створіть портфоліо</strong> - навіть якщо у тебе немає комерційних проектів, створіть кілька робіт для демонстрації навичок</li>
                ...
                <li><strong>Зберігай всі роботи</strong> - вони стануть частиною твого портфоліо</li>
              </ul>
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-gray-700 leading-relaxed text-lg">
                    Так, якщо ти перевищуєте ліміт незареєстрованої діяльності (3500-3600 zł на місяць). Навіть якщо клієнти закордонні, ти все одно зобов'язані декларувати доходи в Польщі, якщо ти податковий резидент.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-700 leading-relaxed text-lg">
                    Так, реєстрація відбувається онлайн через CEIDG. Тобі потрібен лише Profil Zaufany для підпису заяви.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-700 leading-relaxed text-lg">
                    Ні, віртуальний офіс не обов'язковий. ти можеш використати адресу свого проживання. Але віртуальний офіс зручний, якщо ти не хочеш вказувати домашню адресу в публічному реєстрі.
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-gray-700 leading-relaxed text-lg">
                    Це залежить від твого доходу та витрат. Для більшості фрілансерів з невеликими витратами найвигідніший Ryczałt 12% або 8,5%. Для тих, хто має значні витрати, вигідніша Skala podatkowa.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-700 leading-relaxed text-lg">
                    ти платиш 12% від всього доходу без врахування витрат. Наприклад, якщо твій дохід 100 000 zł на рік, податок буде 12 000 zł.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-700 leading-relaxed text-lg">
                    Ні, на Ryczałt витрати не враховуються. ти платиш відсоток від всього доходу.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-700 leading-relaxed text-lg">
                    Це сума, вільна від податку. У 2026 році вона становить близько 30 000 zł. Це означає, що перші 30 000 zł твого доходу не оподатковуються на Skala podatkowa.
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-gray-700 leading-relaxed text-lg">
                    Протягом перших 6 місяців ти звільнений від соціальних внесків завдяки пільзі "Ulga na start". ти платиш лише медичне страхування (близько 400-500 zł на місяць).
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-700 leading-relaxed text-lg">
                    Це пільговий період на 24 місяці після закінчення "Ulga na start". ти платиш внески від зниженої бази, що значно менше повного ZUS.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-700 leading-relaxed text-lg">
                    Так, якщо ти зареєстровані як підприємець, ти зобов'язаний платити ZUS навіть якщо не маєте доходу. Але пільги "Ulga na start" та "Mały ZUS Plus" допомагають зменшити витрати на старті.
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-gray-700 leading-relaxed text-lg">
                    ти зобов'язаний зареєструватися, коли твій річний оборот перевищує 200 000 zł.
                  </p>
                </div>
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p className="text-gray-700 leading-relaxed text-lg">
                    Ні, завдяки угодам про уникнення подвійного оподаткування ти не платиш податок двічі. Податок сплачується в країні, де ти є податковим резидентом.
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-gray-700 leading-relaxed text-lg">
                    Так, але ти втратиш право на деякі пільги ZUS та ставку податку Ryczałt (для певних категорій), якщо послуги ідентичні тим, що ти надавав як працівник. Між звільненням та підписанням B2B-контракту має пройти мінімум 6 місяців.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-700 leading-relaxed text-lg">
                    Так, якщо ти працюєте в офісі клієнта під його прямим керівництвом та за визначеним ним графіком. Це загрожує штрафами та втратою права на пільги.
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-gray-700 leading-relaxed text-lg">
                    Так, на JDG ти відповідаєш за борги бізнесу всім своїм особистим майном: авто, квартирою, коштами на приватних рахунках. На відміну від ТОВ, де відповідальність обмежена статутним капіталом.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-700 leading-relaxed text-lg">
                    Це не обов'язково, але дуже рекомендується, особливо для IT-спеціалістів, маркетологів та консультантів. OC покриває збитки клієнта через твої помилки.
                  </p>
                </div>
              </div>
                    ...
                    "mainEntity": [
                      {
                        ...
                        "acceptedAnswer": {
                          "@type": "Answer",
                          "text": "Так, якщо ти перевищуєте ліміт незареєстрованої діяльності (3500-3600 zł на місяць). Навіть якщо клієнти закордонні, ти все одно зобов'язані декларувати доходи в Польщі, якщо ти податковий резидент."
                        }
                      },
                      {
                        "@type": "Question",
                        ...
                        "acceptedAnswer": {
                          "@type": "Answer",
                          "text": "Це залежить від твого доходу та витрат. Для більшості фрілансерів з невеликими витратами найвигідніший Ryczałt 12% або 8,5%. Для тих, хто має значні витрати, вигідніша Skala podatkowa."
                        }
                      },
                      {
                        "@type": "Question",
                        ...
                        "acceptedAnswer": {
                          "@type": "Answer",
                          "text": "Протягом перших 6 місяців ти звільнений від соціальних внесків завдяки пільзі \"Ulga na start\". ти платиш лише медичне страхування (близько 400-500 zł на місяць)."
                        }
                      },
                      {
                        "@type": "Question",
                        ...
                        "acceptedAnswer": {
                          "@type": "Answer",
                          "text": "Ти зобов'язаний зареєструватися, коли твій річний оборот перевищує 200 000 zł."
                        }
                      },
                      {
                        "@type": "Question",
                      ...
                      },
                      {
                        ...
                        "acceptedAnswer": {
                          "@type": "Answer",
                          "text": "Так, але ти втратиш право на деякі пільги ZUS та ставку податку Ryczałt (для певних категорій), якщо послуги ідентичні тим, що ти надавав як працівник. Між звільненням та підписанням B2B-контракту має пройти мінімум 6 місяців."
                        }
                      },
                      {
                        "@type": "Question",
                      ...
                      },
                      {
                        ...
                        "acceptedAnswer": {
                          "@type": "Answer",
                          "text": "Так, на JDG ти відповідаєш за борги бізнесу всім своїм особистим майном: авто, квартирою, коштами на приватних рахунках. На відміну від ТОВ, де відповідальність обмежена статутним капіталом."
                        }
                      }
                    ]
                  })
              ...
              <div className="mt-8 pt-6 border-t border-gray-200">
                <p className="text-gray-700 leading-relaxed mb-4 text-base">
                  Цей FAQ охоплює найпоширеніші питання фрілансерів про роботу в Польщі. Якщо у тебе є додаткові питання, рекомендую звернутися до бухгалтера або отримати офіційне роз'яснення від податкової.
                </p>
                <p className="text-gray-700 leading-relaxed text-base">
                  Важливо пам'ятати, що законодавство може змінюватися, тому завжди перевіряй актуальність інформації на офіційних сайтах урядів.
                </p>
              </div>
            </div>
          </section>
            ...
            <div className="col-span-2">
              <div className="flex items-center space-x-2 mb-4">
                ...
                <Link
                  ...
                  aria-label="Freelancer.org.pl - головна сторінка"
                >
                  Freelancer.org.pl
                </Link>
              </div>
