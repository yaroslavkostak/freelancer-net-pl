        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <Card className="bg-white shadow-lg mt-6">
              ...
              <CardContent className="space-y-4">
                <p>
                  Наш сайт містить партнерські посилання на сервіс inFakt. При переході за цими посиланнями 
                  та реєстрації в inFakt ми можемо отримати комісію, яка не впливає на ціну послуг для вас.
                </p>
                <p>
                  Ми відстежуємо ефективність партнерської програми для аналітики та покращення сервісу, 
                  але не передаємо особисті дані користувачів третім особам.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-white shadow-lg mt-6">
              <CardHeader>
                <CardTitle>6. Cookies та технології відстеження</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <p>
